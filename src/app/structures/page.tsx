...
export default function StructuresPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      />
      <div className="w-full min-h-[600px] flex items-center justify-center overflow-auto p-4 border rounded-lg bg-background">
        <p className="text-muted-foreground">
          The structure tree visualization is temporarily disabled pending a backend fix.
        </p>
        {/* {isLoading ? (
