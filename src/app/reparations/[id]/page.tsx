...
export default function ReparationDetailPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title={`${t('reparation')} #${id}`} />
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-semibold">{t('attestation_id')}:</span>
                <Badge variant="outline">{data.decharge || 'N/A'}</Badge>
              </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle>{t('items_to_repair')}</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
