...
import { Calendar, User, Undo2 } from "lucide-react";
...
export default function ReversalDetailPage() {
  ...
  React.useEffect(() => {
    const getData = async () => {
      ...
      try {
        ...
        console.error("Failed to fetch reversal:", error);
        setData(null);
      } finally {
        setIsLoading(false);
      }
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title={`${t('reversement')} #${id}`} />
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-semibold">{t('returned_by')}:</span>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle>{t('articles_to_return')}</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
